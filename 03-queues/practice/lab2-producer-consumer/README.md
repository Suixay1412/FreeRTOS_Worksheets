...
- Queue เต็มบ่อย เพราะมี Producers มากกว่า Consumers ทำให้ข้อความบางส่วนถูก Drop

2. ในทดลองที่ 3 ระบบทำงานเป็นอย่างไร?
- ระบบทำงานช้า เพราะมี Consumer เพียงตัวเดียว ทำให้ Queue สะสมข้อมูลไว้รอการประมวลผล

3. Load Balancer แจ้งเตือนเมื่อไหร่?
- จะแจ้งเตือนเมื่อ Queue เต็มหรือว่างเกินไป เพื่อบ่งชี้ว่าระบบไม่สมดุลระหว่างการส่งและรับ
